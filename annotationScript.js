...
const annotations = { 
    ...
    33: "Here I'm using a short paragraph (just one-and-a-half sentences!) to make sure I highlight the idea here: that even if you could hear everything I'm hearing, there's more to what music is. <br><br>Also worth noting the vocabulary here—small words follow an outpouring of more academic jargon.",
    ...
    36: "Surroundings.",
    37: "I dragged out this phrase because I wanted it to feel long. The shortest possible way of saying it is 'buried under those ninety chords.' <br><br>Also worth noting the adjective choices: listless and unsettling by design have the 's' sound, to match pianissimo.",
    38: "Emotional state.",
    ...
    45: "There should be a real question in your head of 'what alliteration is intentional?' Here, 'first' and 'famous'; 'lucky' and 'live' are intentional. 'Famous' modifies 'recordings', the method by which we are exposed to the music; 'live' modifies 'concerts.' They occupy a similar position. 'First' and 'lucky' describe something closer to the musician themself.",
    ...
    50: "Again, using italics lets me gesture vaguely. Also worth noting that it's a good place to use smaller words. Functionally, in this essay, all these italicized phrases <i>could</i> be in quotation marks instead, but it would seriously change the vibes. However, both italicizing and quoting give the 'spoken' vibe, and spoken words are often smaller than written ones.",
    51: "Philosophically, I love the idea that music is at the intersection of sound and listener. But no matter what the idea is, you still need a verb. I really like 'emerge' here: I like the 'm' sound that 'music' and 'emerge' share, and 'emerge' conveys a certain sense of natural-ness.",
