...
const annotations = { 
    ...
    8: "A big moment; in some sense the thesis of the entire essay. It's the first time I <i>really</i> answer the question 'why play music written by living friends rather than dead strangers?'—everything else has been complaints and jokes. <br><br>It also marks the end of the 'introduction,' roughly speaking.",
    9: "I love alliteration. I think this sentence (and essay) makes that quite clear. 'Begin' with the 'basics'; 'adventurous among'; 'experiment' with the 'esoteric'. <br><br>Note also that I maintain parallelism—not only is there alliteration, but it also occurs at the same relative position (right before the em dash that sets off composer names.) In a 'two'-flavored sentence (two clauses with similar vibes), there ought to be balance. <br><br>Finally, there's nothing wrong with writing things your readers won't know. That most readers have not heard of Saariaho, Takemitsu, and Gubaidulina is the intent, as most readers know who Bach, Beethoven, and Chopin are.",
    ...
    11: "This is a nice string of 'p' and 'd' sounds—alliteration and consonance. 'Gra<i>pp</i>le with the <i>p</i>oint of this <i>p</i>ractice. Why s<i>p</i>en<i>d</i> months and months <i>p</i>recision-<i>d</i>rilling <i>d</i>ifficult <i>p</i>assages.' I like it when words sound and look good.",
    ...
    20: "Another subversion of expectations. Given that I've referenced 'triple-octave jumps' and the 'multiple lines notated in four staves,' a reader might expect me to reference the 'single pianissimo chord repeated 90 times.' Instead, I choose to reference the idea of constantly being annoyed at Holden, which lets me use the <i>Postlude</i> later in this essay. To me, structure is everything!",
    ...
    24: "I advise people to never go meta: it's cringe. But I think I get away with it here. Throughout this paragraph, I'm trying to create a sense of 'the author is talking to you, the reader, about this music and the words he's using to talk about this music.'",
    ...
    31: "Weirdly enough, because I'm annotating this, I <i>do</i> get to staple these sounds to my words. Anyway, another long buildup—",
    ...
    42: "Structurally, it's evidently 'most people,' 'I,' 'most people,' 'I.' I experimented with different numbers of paragraphs and different paragraph breaks and felt breaking before the final 'I' seemed best. <br><br>Thanks for reading! I hope you have a better sense of how I write now :)",
    ...
    46: "Starting consecutive sentences the same way is a stylistic choice. To me, it conveys a sense of 'spokenness.'",
    ...
    51: "I love the idea that music lies at the intersection of sound and listener. But whatever the idea is, I still need a verb. I really like 'emerge' here: I like the 'm' sound that 'music' and 'emerge' share, and 'emerge' conveys a certain sense of naturalness.",
    ...
    60: "I've written paragraphs that grow and swell and are struck down by a back-to-earth em dash twice previously: in paragraphs 5 and 9. <br><br>That's not what happens here. These next few words pulse with intensity and conviction.",
